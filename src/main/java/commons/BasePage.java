...
public class BasePage {
    ...
    public boolean isElementUndisplayed(WebDriver driver, String locatorValue, String... restStrings) {
        ...
        if (elements.size() == 0) {
            ...
            System.out.println("Eng time = " + new Date());
            return true;
    ...
    public Object executeJSExecutorForBrowser(WebDriver driver, String javaScript) {
    ...
    public void highlightElement(WebDriver driver, String locatorValue) {
